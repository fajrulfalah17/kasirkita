                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-header">
                            <span class="font-weight-bold"><i class="fa fa-user"></i> Customer</span>
                        </div>
                        <div class="card-body">
                            <form @submit.prevent="handleSearch">
                                <div class="input-group mb-3">
                                    <Link href="/apps/customers/create" v-if="hasAnyPermission(['customers.create'])" class="btn btn-primary input-group-text">
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col" style="width: 25%">Nama Customer</th>
                                ...
                                <tbody>
                                    <tr v-for="(customer, index) in customers.data" :key="index">
                                        <td style="text-transform:uppercase;">{{ customer.name }}</td>
