<template>
  <div class="c-app">
    <div
      ...
      :class="{
        'c-sidebar-lg-show': !$page.url.startsWith('/apps/transactions'),
      }"
      id="sidebar"
    >
    ...
    <div class="c-wrapper c-fixed-components">
      ...
      <div class="c-body">
        ...
        <footer class="c-footer">
          <div>
            <strong>KASIR KITA</strong> &copy; 2022 -
            <a
              href="https://www.instagram.com/arunika_2021/"
              style="text-decoration: none; color: #0f1d35"
            >
              Arunika Production.</a
            >
          </div>
        </footer>
      </div>
